...
set shortmess=aoO
badd +26 plugins_init.vim
badd +239 basic.vim
badd +64 plugins_config.vim
argglobal
silent! argdel *
edit basic.vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 357 - ((28 * winheight(0) + 22) / 44)
...
wincmd w
argglobal
if bufexists('plugins_config.vim') | buffer plugins_config.vim | else | edit plugins_config.vim | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> ,hp <Plug>GitGutterPreviewHunk
nmap <buffer> ,hu <Plug>GitGutterUndoHunk
